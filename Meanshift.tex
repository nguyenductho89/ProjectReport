...
\subsection{What?}
\subsubsection{Clustering and Probability Density Function}
...
The Taylor series of function f(x) that is infinitely differentiable at  number a is the power series\textsuperscript{[2.2]}:
\[
    f(x+\varepsilon) = f(x) + \frac{f'(x)}{1!}\varepsilon+\frac{f''(x)}{2!}\varepsilon^2+\frac{f'''(x)}{3!}\varepsilon^3+...+\frac{f^{(n)}(x)}{n!}\varepsilon^n
\]
\[\Longrightarrow f(x+\varepsilon) \approx f(x) + \frac{f'(x)}{1!}\varepsilon =  f(x) + f'(x)\varepsilon\]
